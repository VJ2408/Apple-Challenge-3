...
let morningEz = [
    Exercise(symbolName: "figure.mind.and.body", name: "Meditating", intensity: "Easy", time: "3 min", instructions: "Yololol", image: Image("placeholderImage"),videoName: "placeholderName"),
    Exercise(symbolName: "figure.run", name: "Running", intensity: "Easy", time: " 3 min", instructions: "Yololol", image: Image("placeholderImage"),videoName: "placeholderName"),
    Exercise(symbolName: "figure.walk", name: "Walking", intensity: "Easy", time: "3 min", instructions: "Yololol", image: Image("placeholderImage"),videoName: "placeholderName"),
]
...
let morningMid = [
    ...
    Exercise(symbolName: "figure.run", name: "Running", intensity: "Medium", time: "3 min", instructions: "Yololol", image: Image("placeholderImage"),videoName: "placeholderName"),
    Exercise(symbolName: "figure.walk", name: "Walking", intensity: "Medium", time: "3 min", instructions: "Yololol", image: Image("placeholderImage"),videoName: "placeholderName")
]
...
let morningHard = [
    ...
    Exercise(symbolName: "figure.mind.and.body", name: "Running", intensity: "Hard", time: "3 min", instructions: "Yololol", image: Image("placeholderImage"),videoName: "placeholderName"),
    Exercise(symbolName: "figure.mind.and.body", name: "Walking", intensity: "Hard", time: "3 min", instructions: "Yololol", image: Image("placeholderImage"),videoName: "placeholderName")
]
...
let nightHard = [
    Exercise(symbolName: "figure.mind.and.body", name: "Walk", intensity: "Hard", time: "3 min", instructions: "Yololol", image: Image("placeholderImage"),videoName: "placeholderName"),
    Exercise(symbolName: "figure.mind.and.body", name: "Running", intensity: "Hard", time: "3 min", instructions: "Yololol", image: Image("placeholderImage"),videoName: "placeholderName"),
    Exercise(symbolName: "figure.mind.and.body", name: "Walking", intensity: "Hard", time: "3 min", instructions: "Yololol", image: Image("placeholderImage"),videoName: "placeholderName")
]
